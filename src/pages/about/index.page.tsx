...
const About: NextPageWithLayout = () => {
  return (
    <section>
      <div className={styles.about_disclaimer}>
        <h1>Layout Example (About)</h1>
      </div>
      <div className={styles.about_section} id="copyright">
      ...
      <div className={styles.about_section} id="terms">
        <h2>Termos de Uso</h2>
        <p>
          This example adds a property <code>getLayout</code> to your page,
          allowing you to return a React component for the layout. This allows
      ...
      <div className={styles.about_section} id="privacy">
